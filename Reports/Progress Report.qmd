...
```{r}
model1 <- lm(data = trunc.robots, formula = Quality ~ Robot + age + gender + marriage + health + lnGDP
   + structure + lnaverwage + as.factor(year) + as.factor(province))
model2 <- lm(data = trunc.robots, formula = Quality ~ Robot + age + gender + marriage + health + lnGDP + structure + lnaverwage)
model3 <- lm(data = trunc.robots, formula = Quality ~ Robot + age + gender + marriage + health + lnGDP
